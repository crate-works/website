...
- **An RO-Crate API** is the access protocol. It specifies how any repository serves its crates over HTTP — discovery, retrieval, deposit, access control.
...
[Seven tools](/#workbench) ship under the CrateWorks umbrella as of this announcement:
...
- And an **RO-Crate API specification** itself, evolving in the open.
...
The technical pieces have been quietly compounding for a while. What was missing was an explicit home for them — a place where decisions about the API, the trademarks, and the relationship between the projects could be made openly, by the people doing the work.

CrateWorks adopts the [Minimum Viable Governance](/governance) framework: a small set of public documents — a charter, a code of conduct, a steering committee roster, a per-project governance policy — that every project agrees to follow. The whole point is to keep ceremony low and decision-making transparent.

If you want to know who's responsible for what, or how to bring a new project in, [the documents are right there](/governance) — short enough to read in one sitting.
